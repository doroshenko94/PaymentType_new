...
const companyOptions = {
    UK: ["Revolut", "Curve", "Zen","Banxa","Rampnetwork","BitGet","Paybis","Kraken","Inserex","Cryptopay","TapBank","AnyCoinDirect","Voucher Coupon"],
    Ireland: ["Revolut", "Zen","Crypto_com", "MEXC","Banxa","Rampnetwork","BitGet","Paybis","Binance","Bybit","Cryptopay","Bitvavo","BTC_Direct","OKX","TapBank","AnyCoinDirect","Voucher Coupon"],
    Italy: ["Revolut", "Bintence_Wire", "Zen","MEXC","Banxa","Rampnetwork","BitGet","Cryptocom","Bybit","Cryptopay","Bitvavo","BTC_Direct","OKX","TapBank","AnyCoinDirect","Voucher Coupon"],
    Denmark: ["Revolut", "Zen","MEXC","Adv2", "Advcash", "W1tty", "Bit2me","BestWallet", "Banxa","Rampnetwork","BitGet","Paybis","Binance","Kraken","Bitvavo","BTC_Direct","OKX","TapBank","AnyCoinDirect","Voucher Coupon"],
    Malasiya: ["Bybit","Luno","Paybis","Help2Pay","Cryptopay","Cryptopay","Voucher Coupon"],
    Canada: ["NDAX","Newton","Bintense","Easypayments","Cryptocom","Kraken","MEW","Beaqonix","Voucher Coupon"],
    New_Zeland: ["Revolut","Paybis","BitGet","Cryptocom","Kraken","Bybit","Cryptopay","TapBank","Inserex","MEW","Voucher Coupon"],
    Bermuda: ["Bestwallet", "Gemini","Voucher Coupon"],
    Switzerland: ["Zen", "Bintence","MEXC", "Cryptocom", "AdvCash", "AdV2", "Bit2me", "Bestwallet","Banxa","Rampnetwork","Bybit","Cryptopay","BTC_Direct","TapBank","AnyCoinDirect","Voucher Coupon"],
    Norway: ["Revolut","Binance","Banxa","Rampnetwork","TapBank","AnyCoinDirect","Voucher Coupon"],
    Bahamas: ["Voucher Coupon"],
    Singapore: ["Revolut","Rampnetwork","Voucher Coupon"],
    Hong_Kong: ["Rampnetwork", "Bintense","Bybit","Cryptopay","Voucher Coupon"],
    Japan: ["Banxa","BitGet","Revolut","Bybit","Cryptopay","Voucher Coupon"],
    UAE: ["Banxa","Rampnetwork","Bintense","Binance","Voucher Coupon"],
    Oman: ["Wise","Binance","Voucher Coupon"],
    Saudi_Arabia:["Banxa","Wise","Binance","Voucher Coupon"],
    Iceland:["Revolut","Zen","Banxa","Rampnetwork","BitGet","Binance","Cryptopay","BTC_Direct","AnyCoinDirect","Voucher Coupon"],
    Greenland:["Banxa","Rampnetwork","Wise","BitGet","Bybit","Cryptopay","Bitvavo","BTC_Direct","AnyCoinDirect","Voucher Coupon"],
    Sweeden:["Banxa","Rampnetwork","Wise","AnyCoinDirect","Voucher Coupon"],
    South_Africa:["Banxa","Rampnetwork", "Luno","Wise","BitGet","VALR","Bybit","Cryptopay","OKX","TapBank","Voucher Coupon"],
    Australia: ["Cryptocom","Kraken","OKX","TapBank","Voucher Coupon"],
    Croatia: ["Bybit","Bitvavo","BTC_Direct","OKX","TapBank","Zen","AnyCoinDirect",],
    Czech: ["Bybit","Cryptopay","Bitvavo","BTC_Direct","OKX","TapBank","AnyCoinDirect","Voucher Coupon"],
    Slovakia: ["Bybit","Cryptopay","Bitvavo","BTC_Direct","OKX","TapBank","AnyCoinDirect","Voucher Coupon"],
    Denmark: ["Bybit","Cryptopay","Bitvavo","BTC_Direct","OKX","AnyCoinDirect","Voucher Coupon"],
